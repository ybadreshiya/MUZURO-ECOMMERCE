...
$send_order= query("INSERT INTO orders(user_id, order_amount, order_transaction,order_status,order_currency, order_date) VALUES ('{$user_id}', '{$amount}','{$transaction}','{$status}','{$currency}', NOW())");
$last_id = last_id();
echo $last_id;
confirm($send_order);
//#########################################################################
